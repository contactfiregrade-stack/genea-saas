    ...
    <main className="min-h-screen bg-[var(--bg)] text-[var(--foreground)]">
      <header className="border-b border-white/10 bg-[var(--nav-bg)] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden gap-2 md:flex">
            ...
            <Link className="nav-item nav-item-active" href="/historique">
              Historique
            </Link>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="page-card">
          ...
          <h1 className="mt-2 text-3xl font-semibold text-slate-900">Vos recherches passées</h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600">
            Cette page affichera l’historique des recherches, les regroupements proches,
            et les analyses déjà lancées.
          </p>
        </div>
      </div>
    </main>
